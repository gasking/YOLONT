...
class YOLONT(nn.Module):
    def __init__(self, device, input_size=None, num_classes=20, trainable=False, conf_thresh=0.0001, nms_thresh=0.50, anchor_size=None, hr=False
                 ,train=True):
        super(YOLONT, self).__init__()
        self.device = device
        ...
        self.model = ShuffleNetV2(model_size='1.0x', train=train)
   
        self.pan=PAN(self.num_classes ).to(self.device)
